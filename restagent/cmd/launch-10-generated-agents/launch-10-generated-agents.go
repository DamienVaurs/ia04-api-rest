...
/**
* Cette commande lance un serveur et une flotte d'agents votants, dotn chacun réalise les commandes suivantes :
...
func main() {
	const n = 10 //nombre d'agents votants lancés
	const nbAlts = 5
	...
	listAgents := restclientagent.Init10VotingAgents(url2, n, nbAlts, channelInList[:], channelOut)
